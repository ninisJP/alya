...
from .views import update_approved_items, RequirementOrderListView,requirement_order_approved_list,  requirement_order_detail_view, update_requirement_order_items, requirement_order_detail_partial
from . import views

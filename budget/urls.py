...
from .views import add_budget_item_htmx, index_budget, create_budget, detail_budget, delete_budget, catalog, export_budget_report, create_sales_order_from_budget, catalog_item_search
from . import views
...
urlpatterns = [
    ...
    path('budget/<int:pk>/add-item/', add_budget_item_htmx, name='add_budget_item_htmx'),  # Nueva URL para HTMX

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, db_index=True, default='', max_length=100, null=True, verbose_name='Nombre del Proveedor')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['name', 'document'], name='logistic_su_name_1d3807_idx')],
            },
        ),
    ]

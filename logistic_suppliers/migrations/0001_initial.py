    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(blank=True, choices=[('Soles', 'Soles'), ('Dolares', 'Dolares')], default='Soles', max_length=20, null=True, verbose_name='Moneda')),
                ('interbank_currency', models.CharField(blank=True, default='', max_length=50, null=True, verbose_name='Número de Cuenta Interbancario')),
            ],
            options={
